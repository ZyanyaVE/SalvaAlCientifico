...
public class Animacion{
	...
	*/
	public synchronized Image getImagen(){
        ...
        /*
            Metodo para dar return al numero de cuadro de animacion deseado
        */
	private cuadroDeAnimacion getCuadro(int i){
        ...
        /*
            Metodo para eliminar cuadros de animacion como meth quebrada o normal
        */
        public void eliminaCuadro(int i){
		 cuadros.remove(i);
	}
	
        /*
            Metodo para regresar y modificar animaciones
        */
